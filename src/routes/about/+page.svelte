...
<section class="bg-warm-white py-20 md:py-28 relative overflow-hidden">
	...
	<div class="relative max-w-6xl mx-auto px-6 lg:px-8">
		<div class="max-w-3xl">
			...
			>
				I've been making engineering teams ship better for a decade<span class="text-primary"
					>.</span
				>
...
<Section background="muted" padding="lg">
	<div class="max-w-2xl mx-auto" use:reveal>
		...
		<h2 class="font-serif text-3xl font-normal text-charcoal mb-8">Why DomeWorks exists</h2>
		<div class="space-y-6 text-lg text-charcoal/70 leading-[1.65]">
			...
			<p class="border-l-2 border-copper pl-6 text-charcoal">
				Over 80% of organizations report no measurable impact on EBIT despite their AI investments <span
					class="text-charcoal/60">(BCG, 2024)</span
...
<Section background="white" padding="lg">
	<div class="max-w-2xl mx-auto" use:reveal>
		...
		<h2 class="font-serif text-3xl font-normal text-charcoal mb-8">How I work</h2>
				...
				<div>
					...
					<p class="text-charcoal/70 leading-[1.65]">
						...
						need ongoing support after that, that's what the <a
							href="/fractional/"
							class="text-primary hover:underline">Fractional engagement</a
