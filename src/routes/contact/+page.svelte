  ...
  <div class="relative max-w-2xl mx-auto px-6 lg:px-8">
    <div class="text-center mb-12">
      ...
      <p class="mt-4 text-lg text-charcoal/70">
        30 minutes on a call and I can tell you whether your team's AI situation is something I can help with.
      </p>
    </div>

    <div class="grid md:grid-cols-2 gap-6">
      <!-- Book a Call -->
      <div class="p-8 bg-warm-white rounded-2xl border-2 border-primary flex flex-col">
        <h2 class="text-xl font-medium text-charcoal mb-3">Book a call</h2>
        <p class="text-charcoal/70 mb-6 flex-grow">
          The best way to start. 30-minute discovery call, no obligation. I'll ask about your team, your tools, and where things are stuck.
        </p>
      ...
      <!-- Send an Email -->
      <div class="p-8 bg-warm-white rounded-2xl border border-charcoal/10 flex flex-col">
        <h2 class="text-xl font-medium text-charcoal mb-3">Send an email</h2>
        <p class="text-charcoal/70 mb-6 flex-grow">
          Prefer email? Tell me about your team and I'll get back within 24 hours.
        </p>
        <Button href={generateGeneralMailto()} variant="secondary" size="lg">
          Send an email
        </Button>
      </div>
    </div>
    ...
    <div class="mt-12 p-8 bg-stone rounded-2xl">
      ...
      <p class="text-charcoal/70 leading-[1.65]">
        On the call, I'll ask about your team size, what AI tools you're using, and where things are stuck. I'll share 2-3 observations about where you might have leverage. If there's a fit, I'll recommend either an <a href="/scan/" class="text-primary hover:underline">AI Scan</a> ($2,500) or a full <a href="/context-build/" class="text-primary hover:underline">Context Build</a> ($10,000+) as a next step. If there isn't a fit, I'll tell you that too.
      </p>
    </div>
  </div>
</section>
