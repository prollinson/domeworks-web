...
<svelte:head>
	...
	/>
	<link rel="canonical" href="https://domeworks.tech/context-build/" />

	<meta property="og:type" content="website" />
	<meta property="og:site_name" content="DomeWorks" />
	<meta property="og:url" content="https://domeworks.tech/context-build/" />
	<meta
		property="og:title"
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Two-week engagement: stakeholder interviews, AI readiness assessment, tool and spend audit, context system design, workflow mapping, blocker analysis, and a prioritized opportunity map.',
	...
	<div class="relative max-w-6xl mx-auto px-6 lg:px-8">
		<div class="max-w-3xl">
			...
			<p class="mt-6 text-xl text-charcoal/70 leading-relaxed">
				A two-week engagement that designs the context system — the infrastructure that feeds your
				domain knowledge, team conventions, and codebase patterns into every AI interaction. The
...
<!-- Four Things Happen -->
<Section background="muted" padding="lg" eyebrow="01" title="Four things happen">
	<div class="max-w-2xl mx-auto space-y-8" use:reveal>
		{#each [{ step: '1', title: 'Stakeholder interviews', desc: "I talk to your engineering leads, product managers, and ops people. Not a survey, but real conversations about how they're using AI, where they're hitting walls, and what would actually help. This is where the real blockers (and the real opportunities) surface." }, { step: '2', title: 'Tool and spend audit', desc: "I map every AI tool, every seat, every subscription. Who's using what, how often, and whether it's doing anything useful. You're probably paying for more AI tooling than you realize." }, { step: '3', title: 'Context system diagnosis', desc: "I evaluate what's in place, and what's missing, between your AI tools and how your team actually ships. Shared context, standard workflows, CI/CD integration, developer tooling. Most teams have none of this. That's why adoption stalls at the individual level." }, { step: '4', title: 'Blocker identification', desc: 'Adoption stalls for specific reasons, often structural, not motivational. I find out which blockers are in your way (missing systems, cultural resistance, knowledge silos, tooling gaps) and how severe they are.' }] as item}
			<div class="flex items-start gap-6">
				<span
					class="flex-shrink-0 w-10 h-10 rounded-lg bg-primary text-white flex items-center justify-center text-sm font-medium"
				>
					{item.step}
				</span>
				<div>
	...
	>
		...
		<div class="p-8 bg-ink rounded-2xl relative overflow-hidden">
			...
			<div class="relative">
				...
				<svg
					viewBox="0 0 220 160"
					class="w-full block"
					aria-label="Context system blueprint diagram showing sources flowing through a context pipeline to surfaces"
				>
					<!-- Source nodes -->
					<rect
						x="8"
						...
						height="28"
						rx="6"
						fill="rgba(13,107,99,0.15)"
						stroke="rgba(13,107,99,0.4)"
						stroke-width="1"
					/>
					<text
						x="38"
					...
					<text
						...
						font-size="9"
						font-weight="600"
						letter-spacing="0.08em">CONTEXT PIPELINE</text
					>
					<!-- Arrows down -->
					...
					<rect
						...
						stroke-width="1"
					/>
					<text x="38" y="134" text-anchor="middle" fill="rgba(255,255,255,0.4)" font-size="8"
						>IDE</text
					>
					<rect
						x="80"
						...
						stroke-width="1"
					/>
					<text x="110" y="134" text-anchor="middle" fill="rgba(255,255,255,0.4)" font-size="8"
						>CI/CD</text
					>
					<rect
						x="152"
						...
						stroke-width="1"
					/>
					<text x="182" y="134" text-anchor="middle" fill="rgba(255,255,255,0.4)" font-size="8"
						>Chat</text
					>
				</svg>
			</div>
		...
		<div class="p-8 bg-ink rounded-2xl relative overflow-hidden">
			...
			<div class="relative">
				...
				<div class="flex flex-col gap-4">
					{#each [{ name: 'Shared context files', effort: '1 week', width: '92%', color: 'bg-primary', dot: 'bg-primary' }, { name: 'PR review agent', effort: '2 weeks', width: '75%', color: 'bg-primary', dot: 'bg-primary' }, { name: 'Onboarding automation', effort: '3 weeks', width: '55%', color: 'bg-copper', dot: 'bg-copper' }, { name: 'Meeting summaries', effort: '4 weeks', width: '30%', color: 'bg-warm-gray', dot: 'bg-warm-gray' }] as item}
						<div>
							...
							<div class="h-[5px] bg-warm-white/[0.06] rounded-full overflow-hidden ml-3.5">
								<div
									class="h-full {item.color} rounded-full opacity-70"
		...
		<div class="p-8 bg-stone rounded-2xl border border-charcoal/10">
			...
			<p class="text-sm text-charcoal/60">
				What domain knowledge needs to flow into AI interactions, and how. A design for the shared
				context, reliable workflows, and developer tooling that make AI useful beyond ad-hoc
				prompting.
			</p>
		</div>
	</div>
...
<!-- What Happens Next -->
<Section background="muted" padding="lg" eyebrow="03" title="What happens next">
	<div class="max-w-2xl mx-auto" use:reveal>
		<div class="p-8 bg-warm-white rounded-2xl border border-charcoal/10">
			<p class="text-lg text-charcoal/70 leading-relaxed mb-4">
				The Context Build is designed to feed into an <a
					href="/orchestration-build/"
					class="text-primary hover:underline">Orchestration Build</a
				>, where we build the agent coordination layer the blueprint calls for. But there's no
				obligation. You get the deliverables either way.
			</p>
			<p class="text-lg text-charcoal/70 leading-relaxed">
				Some teams take the Context Build and build internally. That's fine. The quick wins alone
				tend to pay for the engagement. If you want to keep going, the Context Build gives us a
				clear starting point with no re-discovery and no wasted time.
			</p>
		</div>
	</div>
</Section>
...
<Section background="white" padding="lg" eyebrow="04" title="Investment">
	<div class="max-w-2xl mx-auto" use:reveal>
		<div class="overflow-hidden rounded-2xl border border-charcoal/10">
			<table class="w-full">
				<thead>
				...
				<tbody>
					<tr class="bg-warm-white">
						<td class="px-6 py-4 text-charcoal">5–20 people, 1-2 squads</td>
						<td class="px-6 py-4 text-right text-charcoal font-medium">$10,000</td>
					</tr>
					<tr class="bg-stone">
						<td class="px-6 py-4 text-charcoal">20–80 people, 3-6 squads</td>
						<td class="px-6 py-4 text-right text-charcoal font-medium">$12,500</td>
					</tr>
					<tr class="bg-warm-white">
						<td class="px-6 py-4 text-charcoal">80+ people, multi-department</td>
						<td class="px-6 py-4 text-right text-charcoal font-medium">$15,000</td>
					</tr>
				</tbody>
			</table>
		</div>
	...
	<div class="max-w-2xl mx-auto space-y-4" use:reveal>
		<details class="group p-6 bg-warm-white rounded-xl border border-charcoal/10">
			...
			>
				...
				<svg
					class="w-5 h-5 text-charcoal/60 group-open:rotate-180 transition-transform"
					fill="none"
					stroke="currentColor"
					viewBox="0 0 24 24"
					><path
