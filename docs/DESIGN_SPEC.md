...
- **Consolidation**: Move the "Eyebrow" (e.g., "01", "02") and "Headline" rendering logic _inside_ the `Section` component.
- **Props**:
...
- **Why**: Users _physically trigger_ the solution, making the "Before/After" contrast visceral rather than just textual.
...
- **Behavior**:
  ...
  - **Morphing**: The active navigation pill _glides_ to the new position.
